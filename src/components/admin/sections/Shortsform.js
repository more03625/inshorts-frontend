                        ...
                        loading ? (
                            ...
                            <form onSubmit={handleSubmit}>
                                ...
                                <div className="mb-3 pb-2">
                                    ...
                                    />
                                    <div className="form-text">
                                        <a target="_blank" href="https://www5.lunapic.com/editor/?action=resize">get Image Quickly</a> OR. Use <Link to={{ pathname: 'https://tinypng.com/' }}>Tinypng</Link> or <Link to={{ pathname: 'https://compressimage.toolur.com/' }}>Toolur</Link> to compress images. it should be less than 50KB & Dimensions should be 600 * 358
                                    </div>
